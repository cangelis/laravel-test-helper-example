...
Autoloader::namespaces(array(
    'SimpleValidator' => Bundle::path('simplevalidator') . 'src'
));
Autoloader::map(array(
    'SimpleValidator\Validator' => Bundle::path("simplevalidator") . "simple-validator.class.php",
    'SimpleValidator\ValidatorException' => Bundle::path("simplevalidator") . "simple-validator-exception.class.php"
));
if (Request::cli()) {
    Autoloader::map(array(
